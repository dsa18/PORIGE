...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=2, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_Channel1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_Channel1, CY_INSTANCE_SHORT_NAME=ADC_Channel1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_Channel1, )
module ADC_SAR_v3_10_4 (
	...
	cy_clock_v1_0
		#(.id("38b8fad3-ff8b-4b1d-bd01-e681a26e319d/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
// PGA_Inv_v2_0(Inverting_Gain=3, Power=1, VddaValue=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_Inv_v2_0, CY_CONFIG_TITLE=PGA_Channel1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_Channel1, CY_INSTANCE_SHORT_NAME=PGA_Channel1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PGA_Channel1, )
...
// OpAmp_v1_90(Mode=1, Power=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp_Channel1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_Channel1, CY_INSTANCE_SHORT_NAME=Opamp_Channel1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_Channel1, )
...
module top ;
	...
	wire [0:0] tmpOE__Channel1_R_net;
	wire [0:0] tmpFB_0__Channel1_R_net;
	wire [0:0] tmpIO_0__Channel1_R_net;
	wire [0:0] tmpINTERRUPT_0__Channel1_R_net;
	electrical [0:0] tmpSIOVREF__Channel1_R_net;

	cy_psoc3_pins_v1_10
		#(.id("0af64c17-69a7-4474-a2a7-842b465aae75"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Channel1_R
		 (.oe(tmpOE__Channel1_R_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Channel1_R_net[0:0]}),
		  .analog({Net_2063}),
		  .io({tmpIO_0__Channel1_R_net[0:0]}),
		  .siovref(tmpSIOVREF__Channel1_R_net),
		  .interrupt({tmpINTERRUPT_0__Channel1_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Channel1_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_2002 = ~Gen_ext_Channel1;


    assign Net_1973 = Net_2001 & Net_2002;
    ...
    assign AMuxHw_1_Decoder_is_active = (Net_2100[1:0] == AMuxHw_1_Decoder_old_id) && AMuxHw_1_Decoder_enable;
    
    always @(posedge Net_2059)
    begin
        AMuxHw_1_Decoder_old_id = Net_2100[1:0];
    end
    ...
    CyControlReg_v1_80 Sel_Gen_Channel1 (
        .control_1(Net_2032),
        .control_2(Net_2033),
        .control_3(Net_2034),
        .control_0(Net_2035),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_1981[1:0]));
    defparam Sel_Gen_Channel1.Bit0Mode = 0;
    defparam Sel_Gen_Channel1.Bit1Mode = 0;
    defparam Sel_Gen_Channel1.Bit2Mode = 0;
    defparam Sel_Gen_Channel1.Bit3Mode = 0;
    defparam Sel_Gen_Channel1.Bit4Mode = 0;
    defparam Sel_Gen_Channel1.Bit5Mode = 0;
    defparam Sel_Gen_Channel1.Bit6Mode = 0;
    defparam Sel_Gen_Channel1.Bit7Mode = 0;
    defparam Sel_Gen_Channel1.BitValue = 2;
    defparam Sel_Gen_Channel1.BusDisplay = 1;
    defparam Sel_Gen_Channel1.ExtrReset = 0;
    defparam Sel_Gen_Channel1.NumOutputs = 2;

    CyStatusReg_v1_90 SWReg_Channel1 (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_2031),
        .status_bus(Net_2100[1:0]));
    defparam SWReg_Channel1.Bit0Mode = 0;
    defparam SWReg_Channel1.Bit1Mode = 0;
    defparam SWReg_Channel1.Bit2Mode = 0;
    defparam SWReg_Channel1.Bit3Mode = 0;
    defparam SWReg_Channel1.Bit4Mode = 0;
    defparam SWReg_Channel1.Bit5Mode = 0;
    defparam SWReg_Channel1.Bit6Mode = 0;
    defparam SWReg_Channel1.Bit7Mode = 0;
    defparam SWReg_Channel1.BusDisplay = 1;
    defparam SWReg_Channel1.Interrupt = 0;
    defparam SWReg_Channel1.MaskValue = 0;
    defparam SWReg_Channel1.NumInputs = 2;

    assign Net_2001 = (Net_1981[1:0] == Net_2100[1:0]);

    assign Net_1980 = 1'h1;

    BasicCounter_v1_0 Counter_Channel1 (
        .en(Net_1980),
        .cnt(Net_2100[1:0]),
        .reset(Gen_RST_Channel1),
        .clock(Gen_ext_Channel1));
    defparam Counter_Channel1.Width = 2;
	...
	wire [0:0] tmpOE__Channel_1_net;
	wire [0:0] tmpFB_0__Channel_1_net;
	wire [0:0] tmpIO_0__Channel_1_net;
	wire [0:0] tmpINTERRUPT_0__Channel_1_net;
	electrical [0:0] tmpSIOVREF__Channel_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0e68979e-814b-4213-9515-c44c18993a13"),
		  ...
		  .input_buffer_sel(2'b00))
		Channel_1
		 (.oe(tmpOE__Channel_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Channel_1_net[0:0]}),
		  .analog({Net_2132}),
		  .io({tmpIO_0__Channel_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Channel_1_net),
		  .interrupt({tmpINTERRUPT_0__Channel_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Channel_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
