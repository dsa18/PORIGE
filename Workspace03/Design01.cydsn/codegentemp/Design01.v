...
module top ;
    ...
    assign AMuxHw_1_Decoder_is_active = (EN[1:0] == AMuxHw_1_Decoder_old_id) && AMuxHw_1_Decoder_enable;
    
    always @(posedge Net_2059)
    begin
        AMuxHw_1_Decoder_old_id = EN[1:0];
    end
    ...
    assign Net_2001 = (Net_1981[1:0] == EN[1:0]);
