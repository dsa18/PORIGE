...
// PGA_Inv_v2_0(Inverting_Gain=0, Power=1, VddaValue=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_Inv_v2_0, CY_CONFIG_TITLE=PGA_Channel2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_Channel2, CY_INSTANCE_SHORT_NAME=PGA_Channel2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PGA_Channel2, )
module PGA_Inv_v2_0_9 (
    Vin,
    Vref,
    Vout);
    inout       Vin;
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp_Channel2_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_Channel2_1, CY_INSTANCE_SHORT_NAME=Opamp_Channel2_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_Channel2_1, )
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=2, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_Channel2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_Channel2, CY_INSTANCE_SHORT_NAME=ADC_Channel2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_Channel2, )
module ADC_SAR_v3_10_11 (
	...
	cy_clock_v1_0
		#(.id("75dd853e-dd35-4569-b91c-c57e6c47c1c1/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Vout_Ch2_net;
	wire [0:0] tmpFB_0__Vout_Ch2_net;
	wire [0:0] tmpIO_0__Vout_Ch2_net;
	wire [0:0] tmpINTERRUPT_0__Vout_Ch2_net;
	electrical [0:0] tmpSIOVREF__Vout_Ch2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cb0021ea-87c2-4dc2-a090-dede805b01c8"),
		  ...
		  .input_buffer_sel(2'b00))
		Vout_Ch2
		 (.oe(tmpOE__Vout_Ch2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vout_Ch2_net[0:0]}),
		  .analog({Net_1953}),
		  .io({tmpIO_0__Vout_Ch2_net[0:0]}),
		  .siovref(tmpSIOVREF__Vout_Ch2_net),
		  .interrupt({tmpINTERRUPT_0__Vout_Ch2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vout_Ch2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    OpAmp_v1_90_10 Opamp_Channel2_1 (
        .Vplus(Net_2116),
        .Vout(Net_1837),
        .Vminus(Net_2125));
    defparam Opamp_Channel2_1.Mode = 1;

    ADC_SAR_v3_10_11 ADC_Channel2 (
        .vplus(Net_1839),
        .vminus(Net_2077),
        .soc(Net_1840),
        .eoc(Net_2078),
    ...
    BasicCounter_v1_0 Counter_Channel2 (
        .en(Net_1847),
        .cnt(Net_2115[1:0]),
        .reset(Gen_RST_Channel1),
        .clock(Gen_ext_Channel1));
    defparam Counter_Channel2.Width = 2;

    assign Net_1847 = 1'h1;

    assign Net_1849 = (Net_1848[1:0] == Net_2115[1:0]);

    CyStatusReg_v1_90 SWReg_Channel2 (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_2090),
        .status_bus(Net_2115[1:0]));
    defparam SWReg_Channel2.Bit0Mode = 0;
    defparam SWReg_Channel2.Bit1Mode = 0;
    defparam SWReg_Channel2.Bit2Mode = 0;
    defparam SWReg_Channel2.Bit3Mode = 0;
    defparam SWReg_Channel2.Bit4Mode = 0;
    defparam SWReg_Channel2.Bit5Mode = 0;
    defparam SWReg_Channel2.Bit6Mode = 0;
    defparam SWReg_Channel2.Bit7Mode = 0;
    defparam SWReg_Channel2.BusDisplay = 1;
    defparam SWReg_Channel2.Interrupt = 0;
    defparam SWReg_Channel2.MaskValue = 0;
    defparam SWReg_Channel2.NumInputs = 2;

    CyControlReg_v1_80 Sel_Gen_Channel2 (
        .control_1(Net_2091),
        .control_2(Net_2092),
        .control_3(Net_2093),
        .control_0(Net_2094),
    ...
    defparam Sel_Gen_Channel2.Bit0Mode = 0;
    defparam Sel_Gen_Channel2.Bit1Mode = 0;
    defparam Sel_Gen_Channel2.Bit2Mode = 0;
    defparam Sel_Gen_Channel2.Bit3Mode = 0;
    defparam Sel_Gen_Channel2.Bit4Mode = 0;
    defparam Sel_Gen_Channel2.Bit5Mode = 0;
    defparam Sel_Gen_Channel2.Bit6Mode = 0;
    defparam Sel_Gen_Channel2.Bit7Mode = 0;
    defparam Sel_Gen_Channel2.BitValue = 2;
    defparam Sel_Gen_Channel2.BusDisplay = 1;
    defparam Sel_Gen_Channel2.ExtrReset = 0;
    defparam Sel_Gen_Channel2.NumOutputs = 2;

    // -- AMuxHw AMuxHw_2 start -- ***
    
    // -- AMuxHw Decoder Start--
    
    reg [3:0] AMuxHw_2_Decoder_one_hot;
    reg [1:0] AMuxHw_2_Decoder_old_id;
    ...
    assign AMuxHw_2_Decoder_is_active = (Net_2115[1:0] == AMuxHw_2_Decoder_old_id) && AMuxHw_2_Decoder_enable;
    
    always @(posedge Net_2113)
    begin
        AMuxHw_2_Decoder_old_id = Net_2115[1:0];
    end
    
    generate
        for (AMuxHw_2_Decoder_i = 0; AMuxHw_2_Decoder_i < 4; AMuxHw_2_Decoder_i = AMuxHw_2_Decoder_i + 1 )
    ...
    cy_psoc3_amux_v1_0 #(
        ...
        .hw_ctrl_en(AMuxHw_2_Decoder_one_hot[3:0]),
        .vout(Net_2116)
        );
    ...
    assign Net_1840 = Net_1849 & Net_1870;
