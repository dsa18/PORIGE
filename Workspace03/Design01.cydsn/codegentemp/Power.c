...
*
* \funcusage
*  \snippet Power_SUT.c usage_Power_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Power_SUT.c usage_Power_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Power_SUT.c usage_Power_Read  
*******************************************************************************/
...
* preferred Power_Read() API because the 
* Power_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Power_SUT.c usage_Power_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Power_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Power_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Power_0_INTR       (First pin in the list)
    *  - Power_1_INTR       (Second pin in the list)
    *  - ...
    *  - Power_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Power_SUT.c usage_Power_SetInterruptMode
    *******************************************************************************/
    void Power_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Power_0_INTR) != 0u) 
		{ 
			 Power_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Power_SUT.c usage_Power_ClearInterrupt
    *******************************************************************************/
