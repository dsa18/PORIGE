...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBUART_1_DEVICE0_CONFIGURATION0_DESCR[108u] = {
/*  Config Descriptor Length               */ 0x09u,
/*  DescriptorType: CONFIG                 */ 0x02u,
/*  wTotalLength                           */ 0x6Cu, 0x00u,
...
/*  bInterfaceCount                        */ 0x01u,
/*  bFunctionClass                         */ 0x03u,
/*  bFunctionSubClass                      */ 0x00u,
/*  bFunctionProtocol                      */ 0x03u,
/*  iFunction                              */ 0x00u,
/*********************************************************************
...
/*  wDescriptorLength (LSB)                */ USBUART_1_HID_RPT_1_SIZE_LSB,
/*  wDescriptorLength (MSB)                */ USBUART_1_HID_RPT_1_SIZE_MSB,
/*********************************************************************
* Endpoint Descriptor
*********************************************************************/
/*  Endpoint Descriptor Length             */ 0x07u,
...
*********************************************************************/
const uint8 CYCODE USBUART_1_STRING_DESCRIPTORS[323u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "Doug Bartlett"
*********************************************************************/
/* Descriptor Length                       */ 0x1Cu,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'D', 0u,(uint8)'o', 0u,(uint8)'u', 0u,(uint8)'g', 0u,(uint8)' ', 0u,
 (uint8)'B', 0u,(uint8)'a', 0u,(uint8)'r', 0u,(uint8)'t', 0u,(uint8)'l', 0u,
 (uint8)'e', 0u,(uint8)'t', 0u,(uint8)'t', 0u,
/*********************************************************************
* String Descriptor: "GearRatio"
*********************************************************************/
/* Descriptor Length                       */ 0x14u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'G', 0u,(uint8)'e', 0u,(uint8)'a', 0u,(uint8)'r', 0u,(uint8)'R', 0u,
 (uint8)'a', 0u,(uint8)'t', 0u,(uint8)'i', 0u,(uint8)'o', 0u,
/*********************************************************************
* String Descriptor: "GearRatio Keyboard"
*********************************************************************/
/* Descriptor Length                       */ 0x26u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'G', 0u,(uint8)'e', 0u,(uint8)'a', 0u,(uint8)'r', 0u,(uint8)'R', 0u,
 (uint8)'a', 0u,(uint8)'t', 0u,(uint8)'i', 0u,(uint8)'o', 0u,(uint8)' ', 0u,
 (uint8)'K', 0u,(uint8)'e', 0u,(uint8)'y', 0u,(uint8)'b', 0u,(uint8)'o', 0u,
 (uint8)'a', 0u,(uint8)'r', 0u,(uint8)'d', 0u,
/*********************************************************************
* String Descriptor: "Keboart"
*********************************************************************/
/* Descriptor Length                       */ 0x10u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'K', 0u,(uint8)'e', 0u,(uint8)'b', 0u,(uint8)'o', 0u,(uint8)'a', 0u,
 (uint8)'r', 0u,(uint8)'t', 0u,
/*********************************************************************
* String Descriptor: "Volue Contr"
*********************************************************************/
/* Descriptor Length                       */ 0x18u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'V', 0u,(uint8)'o', 0u,(uint8)'l', 0u,(uint8)'u', 0u,(uint8)'e', 0u,
 (uint8)' ', 0u,(uint8)'C', 0u,(uint8)'o', 0u,(uint8)'n', 0u,(uint8)'t', 0u,
 (uint8)'r', 0u,
/*********************************************************************
* String Descriptor: "ddddd"
*********************************************************************/
/* Descriptor Length                       */ 0x0Cu,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'d', 0u,(uint8)'d', 0u,(uint8)'d', 0u,(uint8)'d', 0u,(uint8)'d', 0u,
/*********************************************************************/
...
*********************************************************************/
const uint8 CYCODE USBUART_1_HIDREPORT_DESCRIPTOR1[69u] = {
...
/*********************************************************************/
/*********************************************************************
* HID Report Descriptor: Volue Contr
*********************************************************************/
const uint8 CYCODE USBUART_1_HIDREPORT_DESCRIPTOR2[42u] = {
/*  Descriptor Size (Not part of descriptor)*/ USBUART_1_HID_RPT_2_SIZE_LSB,
USBUART_1_HID_RPT_2_SIZE_MSB,
/* USAGE_PAGE                              */ 0x05u, 0x01u, 
/* USAGE                                   */ 0x09u, 0x02u, 
/* COLLECTION                              */ 0xA1u, 0x01u, 
/* USAGE                                   */ 0x09u, 0x01u, 
...
#if !defined(USER_DEFINE_USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_HID_RPT_STORAGE)
/*********************************************************************
* HID Input Report Storage
*********************************************************************/
T_USBUART_1_XFER_STATUS_BLOCK USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_RPT_SCB;
uint8 USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_BUF[
            USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_BUF_SIZE];

/*********************************************************************
* HID Input Report TD Table
*********************************************************************/
const T_USBUART_1_TD CYCODE USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_RPT_TABLE[1u] = {
    {USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_BUF_SIZE,
    &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_BUF[0u],
    &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_RPT_SCB},
};
/*********************************************************************
* HID Feature Report Storage
*********************************************************************/
T_USBUART_1_XFER_STATUS_BLOCK USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_RPT_SCB;
uint8 USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_BUF[
            USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_BUF_SIZE];

/*********************************************************************
* HID Feature Report TD Table
*********************************************************************/
const T_USBUART_1_TD CYCODE USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_RPT_TABLE[1u] = {
    {USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_BUF_SIZE,
    &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_BUF[0u],
    &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_RPT_SCB},
};
/*********************************************************************
...
*                                        HID Class Descriptor
*********************************************************************/
const T_USBUART_1_LUT CYCODE USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_TABLE[5u] = {
    {0x00u,     &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_IN_RPT_TABLE},
    {0x00u,    NULL},
    {0x00u,     &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_FEATURE_RPT_TABLE},
    {0x01u,     (const void *)&USBUART_1_HIDREPORT_DESCRIPTOR1[0]},
    {0x01u,     (const void *)&USBUART_1_DEVICE0_CONFIGURATION0_DESCR[92]}
};
#endif /* USER_DEFINE_USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_HID_RPT_STORAGE */

/*********************************************************************
* Interface Dispatch Table -- Points to the Class Dispatch Tables
*********************************************************************/
const T_USBUART_1_LUT CYCODE USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_TABLE[1u] = {
    {USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_COUNT, 
    &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_ALTERNATE0_HID_TABLE}
};
/*********************************************************************
...
*********************************************************************/
const T_USBUART_1_EP_SETTINGS_BLOCK CYCODE USBUART_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[4u] = {
...
const uint8 CYCODE USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[3u] = {
0x02u, 0x0Au, 0x03u
};
/*********************************************************************
...
*********************************************************************/
const T_USBUART_1_LUT CYCODE USBUART_1_DEVICE0_CONFIGURATION0_TABLE[6u] = {
    {0x01u,     &USBUART_1_DEVICE0_CONFIGURATION0_DESCR},
    {0x04u,     &USBUART_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x01u,     &USBUART_1_DEVICE0_CONFIGURATION0_INTERFACE4_TABLE},
