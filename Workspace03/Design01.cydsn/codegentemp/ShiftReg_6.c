...
{
    CY_SET_REG24(ShiftReg_6_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG24(ShiftReg_6_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG24(ShiftReg_6_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint32 ShiftReg_6_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG24(ShiftReg_6_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG24(ShiftReg_6_OUT_FIFO_VAL_LSB_PTR);
