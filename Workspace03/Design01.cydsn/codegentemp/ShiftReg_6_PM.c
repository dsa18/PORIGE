...
void ShiftReg_6_SaveConfig(void) 
{
    ...
    ShiftReg_6_backup.saveSrA0Reg   = CY_GET_REG24(ShiftReg_6_SHIFT_REG_LSB_PTR);
    ShiftReg_6_backup.saveSrA1Reg   = CY_GET_REG24(ShiftReg_6_SHIFT_REG_VALUE_LSB_PTR);
...
void ShiftReg_6_RestoreConfig(void) 
{
    ...
    CY_SET_REG24(ShiftReg_6_SHIFT_REG_LSB_PTR, ShiftReg_6_backup.saveSrA0Reg);
    CY_SET_REG24(ShiftReg_6_SHIFT_REG_VALUE_LSB_PTR, ShiftReg_6_backup.saveSrA1Reg);
