...
void ShiftReg_8_SaveConfig(void) 
{
    ...
    ShiftReg_8_backup.saveSrA0Reg   = CY_GET_REG24(ShiftReg_8_SHIFT_REG_LSB_PTR);
    ShiftReg_8_backup.saveSrA1Reg   = CY_GET_REG24(ShiftReg_8_SHIFT_REG_VALUE_LSB_PTR);
...
void ShiftReg_8_RestoreConfig(void) 
{
    ...
    CY_SET_REG24(ShiftReg_8_SHIFT_REG_LSB_PTR, ShiftReg_8_backup.saveSrA0Reg);
    CY_SET_REG24(ShiftReg_8_SHIFT_REG_VALUE_LSB_PTR, ShiftReg_8_backup.saveSrA1Reg);
