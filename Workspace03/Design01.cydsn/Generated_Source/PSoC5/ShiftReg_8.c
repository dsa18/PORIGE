...
{
    CY_SET_REG24(ShiftReg_8_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG24(ShiftReg_8_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG24(ShiftReg_8_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint32 ShiftReg_8_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG24(ShiftReg_8_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG24(ShiftReg_8_OUT_FIFO_VAL_LSB_PTR);
